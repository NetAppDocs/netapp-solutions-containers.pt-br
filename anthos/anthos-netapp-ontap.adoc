...
Para obter mais informações sobre as plataformas NetApp AFF e FAS, consulte o link:https://docs.netapp.com/platstor/index.jsp["NetApp documentação da plataforma de hardware"^].
