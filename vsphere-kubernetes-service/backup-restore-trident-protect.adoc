...
[%collapsible]
====
Este exemplo aborda a proteção de dados para o aplicativo PostgreSQL de exemplo, que está instalado no  `postgres`namespace. Para obter detalhes sobre a instalação, consulte link:deploy-vks-workloads.html["Implemente cargas de trabalho VKS usando o armazenamento NetApp"].
