...
summary: Log de alterações recentes no material de apoio das soluções de contêiner da NetApp . 
---
= Novidades nas soluções de contêiner da NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
Aprenda o que há de novo em soluções de contêineres.
