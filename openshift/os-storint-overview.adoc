...
Trident, um provisionador e orquestrador de armazenamento de código aberto mantido pela NetApp, juntamente com seu complemento, NetApp Trident Protect, oferece soluções robustas para orquestrar e gerenciar dados persistentes em ambientes baseados em contêineres, como Red Hat OpenShift.
