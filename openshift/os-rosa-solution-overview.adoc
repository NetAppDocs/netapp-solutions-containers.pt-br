...
* Leme 3link:https://docs.aws.amazon.com/eks/latest/userguide/helm.html["documentação"]
...
Use o sinalizador node-prep e instale o Trident conforme mostrado.  Antes de emitir o comando de instalação, você deve ter baixado o pacote do instalador. Consulte link:https://docs.netapp.com/us-en/trident/trident-get-started/kubernetes-deploy-tridentctl.html#step-1-download-the-trident-installer-package["a documentação aqui"] .
...
image:redhat-openshift-container-rosa-017.png["tabela, esquema, linhas postgresql"]
