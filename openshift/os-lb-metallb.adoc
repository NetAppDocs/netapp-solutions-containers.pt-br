...
NOTE: Se você deseja configurar o MetalLB no modo BGP, pule a etapa 6 acima e siga o procedimento na documentação do MetalLBlink:https://metallb.universe.tf/concepts/bgp/["aqui"] .
