...
. Siga as link:https://docs.openshift.com/container-platform/4.7/installing/index.html["instruções de instalação"^] instruções fornecidas pela Red Hat para implantar no ambiente de sua escolha.
...
* link:os-on-bm.html["OpenShift em Bare Metal"]
* link:os-on-openstack.html["OpenShift na plataforma Red Hat OpenStack"]
* link:os-on-rhv.html["OpenShift na virtualização Red Hat"]
* link:os-on-vmw.html["OpenShift no VMware vSphere"]
