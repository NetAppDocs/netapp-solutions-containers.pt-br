...
. Instale a extensão F5 Application Services 3 para permitir que os sistemas BIG-IP aceitem configurações em JSON em vez de comandos imperativos. Acesse link:https://github.com/F5Networks/f5-appsvcs-extension/releases["Repositório F5 AS3 GitHub"^] e baixe o arquivo RPM mais recente.
