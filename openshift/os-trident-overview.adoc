...
Consulte o link:https://docs.netapp.com/us-en/trident/index.html["Documentação do produto Trident"^] para obter detalhes sobre a instalação e configuração.
...
. Faça o download do arquivo de instalação para a estação de trabalho do administrador e extraia o conteúdo. A versão atual do Trident pode ser baixada do link:https://github.com/NetApp/trident/releases?q=25.&expanded=true["Página de versões do Trident no GitHub"^].
