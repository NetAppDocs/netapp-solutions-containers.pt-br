...
NetApp Trident é um orquestrador de storage de código aberto e totalmente suportado para contêineres e distribuições Kubernetes como {k8s_distribution_name}. Para mais informações, visite o link:https://docs.netapp.com/us-en/trident/index.html["Documentação do Trident"^].
...
Uma matriz de suporte para qual versão do Trident foi testada com qual distribuição do Kubernetes pode ser encontrada em link:https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators["Frontends suportados (orquestradores)"^].
